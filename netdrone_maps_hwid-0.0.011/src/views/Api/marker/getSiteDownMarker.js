...
// yxl 地图markers的服务
export function getSiteDownMarker(status, hubType, vip, siteType, region, siteDown, start_time, end_time, siteStr = '') {
	let siteList = siteStr ? siteStr.split(',') : [];
	return new Promise((resolve, reject) => {
		MessageProcessor.process({
			serviceId: "/CN_GSC_ID_Surge_Noc_Dashboard/netdrone_maps/nm_get_site_down_maps_info",
