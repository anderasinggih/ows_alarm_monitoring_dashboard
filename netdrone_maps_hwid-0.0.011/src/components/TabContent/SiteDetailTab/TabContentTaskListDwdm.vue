<template>
	<div class="tab-pane fade" id="task-list-dwdm-site-pane" role="tabpanel" aria-labelledby="task-list-dwdm-site-tab" tabindex="0">
		<div class="row mb-3">
			<div class="col-6">
					...
					<div class="accordion-item">
						...
						<div :id="'taskListAcr' + data.wo_id" class="accordion-collapse collapse" :data-bs-parent="'#taskListAccordion' + data.wo_id">
							<div class="accordion-body">
								...
								<div class="row mb-2">
									<div class="col-4">
										<p class="font-12 font-500 text-grey">Suspect Cause3</p>
									</div>
									<div class="col-8">
