<template>
	<div class="tab-pane fade" id="tt-list-node-pane" role="tabpanel" aria-labelledby="tt-list-node-tab" tabindex="0">
		<div class="row mb-3">
			<div class="col-6">
								...
								<div v-if="data.wo_id != undefined" class="row mb-2">
									...
									<div class="col-8">
										<p class="font-12 font-500 text-dark">
											{{ data.ticket_id }}
											<i v-if="data.ticket_id" class="ms-3 bi bi-copy text-ioh font-16 c-pointer" @click="copyWoIdSite(data.wo_id)"></i>
										</p>
									</div>
								</div>
