<template>
	<div class="tab-pane fade" id="task-list-node-pane" role="tabpanel" aria-labelledby="task-list-node-tab" tabindex="0">
		<div class="row mb-3">
			<div class="col-6">
					...
					<div class="accordion-item">
						...
						<div :id="'taskListAcr' + data.wo_id" class="accordion-collapse collapse" :data-bs-parent="'#taskListAccordion' + data.wo_id">
							<div class="accordion-body">
								...
								<div class="row mb-2">
									<div class="col-4">
										<p class="font-12 font-500 text-grey">Suspect Cause4</p>
									</div>
									<div class="col-8">
...
export default {
	name: "TabContentNodeTaskListSiteDetail",
	data() {
		return IndexData;
	},
	computed: {
